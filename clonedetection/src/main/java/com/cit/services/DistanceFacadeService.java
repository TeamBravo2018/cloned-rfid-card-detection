...
public class DistanceFacadeService implements IDistanceService {
    ...
    @Autowired
    public DistanceFacadeService(com.cit.services.GoogleDistanceService googleDistanceService, LocalDistanceService localDistanceService, FlyAndDriveDistanceService flyAndDriveDistanceService) {
